...
const ResultTable: React.FC<ResultTable> = ({ title, results }) => {
    return (
        <div className="container mx-auto">
            ...
            <div className="overflow-x-auto shadow-lg rounded-lg max-h-96 overflow-y-scroll">
                <table className="min-w-full bg-white">
                    <thead>
                        <tr className="w-full bg-indigo-600 text-white text-left">
                            <th className="py-3 px-4 uppercase font-semibold text-sm sticky top-0">No</th>
                            <th className="py-3 px-4 uppercase font-semibold text-sm sticky top-0">Text</th>
                            <th className="py-3 px-4 uppercase font-semibold text-sm sticky top-0">Label</th>
                            <th className="py-3 px-4 uppercase font-semibold text-sm sticky top-0">Score</th>
                        </tr>
                    </thead>
                    <tbody>
                        {results.map((data, i) => (
